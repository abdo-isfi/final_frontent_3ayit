...
const AbsenceSGPage = () => {
  ...
  // Function to apply period filter to dates - simplified version without timePeriod
  const isDateInSelectedPeriod = (dateStr) => {
    // Always return true since we removed the period filter
    return true;
  };
  
  const filterAbsences = () => {
    // Start with all absences - no period filtering
